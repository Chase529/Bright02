...
public class RoleService implements RoleManager{
	 ...
	 * @throws Exception
	 */
	public void setApproversPowers(PageData pd) throws Exception {
		dao.update("RoleMapper.setApproversPowers", pd);
	}
	 ...
	 */
	@Override
	public PageData getRoleIdByRoleName(String roleName) throws Exception {
		return (PageData) dao.findForObject("RoleMapper.getRoleIdByRoleName",roleName);
	}
