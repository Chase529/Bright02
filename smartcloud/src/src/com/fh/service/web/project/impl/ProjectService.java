package com.fh.service.web.project.impl;
...
public class ProjectService implements ProjectManager{
	 ...
	 */
	@Override
	public List<PageData> getProjectInfoByMapBianma(String bianma) throws Exception {
		return (List<PageData>)dao.findForList("ProjectMapper.getProjectInfoByMapBianma", bianma);
	}
