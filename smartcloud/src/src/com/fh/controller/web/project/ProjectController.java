package com.fh.controller.web.project;
...
public class ProjectController extends BaseController {
	...
	public ModelAndView list(Page page) throws Exception{
		...
		mv.setViewName("web/project/project_list");
	...
	public ModelAndView goAdd()throws Exception{
		...
		PageData pd = new PageData();
		pd = this.getPageData();
		List<Dictionaries> provinceList = dictionariesService.listSubDictByParentId("1");
		mv.setViewName("web/project/project_edit");
	...
	public ModelAndView exportExcel() throws Exception{
		...
		for(int i=0;i<varOList.size();i++){
			...
			vpd.put("var2", varOList.get(i).getString("PROJECT_URL"));	    //2
			vpd.put("var3", varOList.get(i).getString("LONGITUDE"));	    //3
			vpd.put("var4", varOList.get(i).getString("LATITUDE"));	    //4
			vpd.put("var5", varOList.get(i).getString("CREATE_USER_ID"));	    //5
