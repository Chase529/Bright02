...
<base href="<%=basePath%>">
	...
	<body class="no-skin">
			...
			<div class="main-content">
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div>
							<iframe name="mainFrame" id="mainFrame" frameborder="0" src="tab.do" style="margin:0 auto;width:100%;height:100%;"></iframe>	</div>
						</div><!-- /.row -->	
					</div><!-- /.page-content -->
		...
		<!--跳转界面-->
		<script type="text/javascript" >
            var hashValue = window.location.hash; //获取哈希值
            var lianJie=window.location.href
            console.log(lianJie.split("#")[0]);
            console.log(hashValue);
            console.log("into index");
            var jump = lianJie.split("#")[0];
            switch (jump){
                //人员
				case jump=='personnel':
                    window.onload=function () {
                        siMenu('z170','lm168','外包公司员工','outcomstaff/list.do')
                    }
				    break;
				//安全
				case jump=='security':
                    window.onload=function () {
                        siMenu('z145','lm129','安全巡查','inspect/list.do')
                    }
                    break;
				//进度
				case jump=='progress':
                    window.onload=function () {
                        siMenu('z161','lm160','项目工程','engineering/listTree.do?ENGINEERING_ID=0')
                    }
                	break;
				//质量
				case jump=='quality':
                    window.onload=function () {
                        siMenu('z135','lm134','质量巡查管理','quality_inspect/list.do')
                    }
                    break;
			}
//            if(jump){
...
//				//调用跳转方法
//            	window.onload=function () {
//                    siMenu('z1','12','项目管理','project/list.do');
//                }
//			}
		</script>
	</body>
