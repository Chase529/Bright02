...
public class Const {
	...
	public static final String NO_INTERCEPTOR_PATH = ".*/((login)|(logout)|(code)|(app)|(weixin)|(terrace)|(static)|(main)|(websocket)|(uploadImgs)|(file)|(thirdLogin)|(web)|(webapp)|(login)|(personnelPositioning)|(postCheckData)|(plugins)|(postWeighbridgeData)).*";	//不对匹配该值的访问路径拦截（正则）
