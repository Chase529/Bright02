...
public class Role {
	...
	private String CAN_SET_APPROVERS;
	
	
	public String getCAN_SET_APPROVERS() {
		return CAN_SET_APPROVERS;
	}
	public void setCAN_SET_APPROVERS(String cAN_SET_APPROVERS) {
		CAN_SET_APPROVERS = cAN_SET_APPROVERS;
	}
