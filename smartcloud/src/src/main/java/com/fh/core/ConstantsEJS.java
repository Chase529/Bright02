...
public class ConstantsEJS {
     ...
     * 微信jsapi_tickaet 
     */
    public static final String WX_JSAPI_TICKAET						   = "wx_jsapi_ticket";
    ...
    /** API每个页面显示的列表数量；  */
   	public static final int DEFAULT_PAGE_SIZE_FORAPI =                  10;
     ...
     * 供应商申请上传图片 
     */
    public final static String SUPPLIER_APPLY                          = "supplier_apply";
    
    public final static String PRODUCT_CATE = "product_cate";
    ...
    /**商家入驻审核通知  */
    public final static String SELLER_APPLY_SUBJECT                = "商家入驻审核通知";

    /** 通过 */
    public final static String    SELLER_APPLY_SUCCESS                  = "恭喜您，您在我平台申请的商家入驻审核通过，欢迎使用!";

    /** 失败 */
    public final static String SELLER_APPLY_FAIL               = "很遗憾，您在我平台申请的商家入驻审核失败，请更新资料后重新提交审核!";
