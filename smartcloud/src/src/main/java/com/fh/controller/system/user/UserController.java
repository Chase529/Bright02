...
import com.fh.util.ObjectExcelRead2;
...
public class UserController extends BaseController {
	...
	public ModelAndView readExcel(
		...
		if (null != file && !file.isEmpty()) {
			...
			List<PageData> listPd = (List)ObjectExcelRead2.readExcel(filePath, fileName, 2, 0, 0);
			//List<PageData> listPd = (List)ObjectExcelRead2.readExcelToObj(filePath, fileName, 2, 0, 0);
