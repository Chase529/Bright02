		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
							<form action="happuser/readExcel.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
								<div id="zhongxin">
								<table style="width:95%;" >
									...
									<tr>
										<td style="text-align: center;padding-top: 10px;">
											...
											<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/happuser/downExcel.do'">下载模版</a>
										</td>
									</tr>
								</table>
								</div>
