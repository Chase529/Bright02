		...
		<div id="loginbox" >
			<form action="" method="post" name="loginForm" id="loginForm">
				<div class="control-group normal_text">
					<h2 style="font-family:Simsun;font-weight:bold;">
						智慧云平台
					</h2>
				</div>
				...
				<div class="control-group">
					<div class="controls">
						<div class="main_input_box">
							...
							<!--  <input type="password" name="password" id="password" placeholder="请输入密码" class="keypad" keypadMode="full" allowKeyboard="false" value=""/> -->
						</div>
					</div>
				</div>
	...
	<div id="templatemo_banner_slide" class="container_wapper">
		<div class="camera_wrap camera_emboss" id="camera_slide">
			...
			<c:choose>
				...
				<c:otherwise>
					<div data-src="static/login/images/banner_slide.jpg"></div>
				</c:otherwise>
			</c:choose>
			-->
				<div data-src="static/login/images/banner_slide.jpg"></div>
                ...
                $.ajax({
                    ...
                    success: function(data){
                        if("success" == data.result){
                            saveCookie();
                            window.location.href="<%=basePath%>main/index#"+lianJie.split("#")[1].split("=")[1];
